...
setwd(wdd)
hcc <- "DE"
c1 <- get.allCR(hh1n="DE-Q-itarg11-h1.Rdata",
                hh1s="PVAR-Q-itarg1-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="DE-Q-itarg11-h2.Rdata",
                hh1s="PVAR-Q-itarg1-h2.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="DE-Q-itarg11-h3.Rdata",
                hh1s="PVAR-Q-itarg1-h3.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="DE-Q-itarg11-h4.Rdata",
                hh1s="PVAR-Q-itarg1-h4.Rdata",
                hc=hcc)
...
setwd(wdd)
hcc <- "FR"
c1 <- get.allCR(hh1n="FR-Q-itarg11-h1.Rdata",
                hh1s="PVAR-Q-itarg1-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="FR-Q-itarg11-h2.Rdata",
                hh1s="PVAR-Q-itarg1-h2.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="FR-Q-itarg11-h3.Rdata",
                hh1s="PVAR-Q-itarg1-h3.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="FR-Q-itarg11-h4.Rdata",
                hh1s="PVAR-Q-itarg1-h4.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
...
setwd(wdd)
hcc <- "IT"
c1 <- get.allCR(hh1n="IT-Q-itarg11-h1.Rdata",
                hh1s="PVAR-Q-itarg1-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="IT-Q-itarg11-h2.Rdata",
                hh1s="PVAR-Q-itarg1-h2.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="IT-Q-itarg11-h3.Rdata",
                hh1s="PVAR-Q-itarg1-h3.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="IT-Q-itarg11-h4.Rdata",
                hh1s="PVAR-Q-itarg1-h4.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
...
setwd(wdd)
hcc <- "UK"
c1 <- get.allCR(hh1n="UK-Q-itarg11-h1.Rdata",
                hh1s="PVAR-Q-itarg1-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="UK-Q-itarg11-h2.Rdata",
                hh1s="PVAR-Q-itarg1-h2.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="UK-Q-itarg11-h3.Rdata",
                hh1s="PVAR-Q-itarg1-h3.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="UK-Q-itarg11-h4.Rdata",
                hh1s="PVAR-Q-itarg1-h4.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
