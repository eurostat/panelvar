...
c2 <- get.allCR(hh1n="DE-M-itarg2342-h3.Rdata",
                hh1s="PVAR-M-itarg2342-h3.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="DE-M-itarg2342-h6.Rdata",
                hh1s="PVAR-M-itarg2342-h6.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="DE-M-itarg2342-h12.Rdata",
                hh1s="PVAR-M-itarg2342-h12.Rdata",
                hc=hcc)
...
setwd(wdd)
hcc <- "FR"
c1 <- get.allCR(hh1n="FR-M-itarg2342-h1.Rdata",
                hh1s="PVAR-M-itarg2342-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="FR-M-itarg2342-h3.Rdata",
                hh1s="PVAR-M-itarg2342-h3.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="FR-M-itarg2342-h6.Rdata",
                hh1s="PVAR-M-itarg2342-h6.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="FR-M-itarg2342-h12.Rdata",
                hh1s="PVAR-M-itarg2342-h12.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
...
c2 <- get.allCR(hh1n="IT-M-itarg2342-h3.Rdata",
                hh1s="PVAR-M-itarg2342-h3.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="IT-M-itarg2342-h6.Rdata",
                hh1s="PVAR-M-itarg2342-h6.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="IT-M-itarg2342-h12.Rdata",
                hh1s="PVAR-M-itarg2342-h12.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
...
setwd(wdd)
hcc <- "UK"
c1 <- get.allCR(hh1n="UK-M-itarg2342-h1.Rdata",
                hh1s="PVAR-M-itarg2342-h1.Rdata",
                hc=hcc)

c2 <- get.allCR(hh1n="UK-M-itarg2342-h3.Rdata",
                hh1s="PVAR-M-itarg2342-h3.Rdata",
                hc=hcc)

c3 <- get.allCR(hh1n="UK-M-itarg2342-h6.Rdata",
                hh1s="PVAR-M-itarg2342-h6.Rdata",
                hc=hcc)

c4 <- get.allCR(hh1n="UK-M-itarg2342-h12.Rdata",
                hh1s="PVAR-M-itarg2342-h12.Rdata",
                hc=hcc)
cc <- cbind(c1, c2, c3, c4)
